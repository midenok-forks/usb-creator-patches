...
LPCTSTR = c_wchar_p
LPTSTR = c_wchar_p
LPOFNHOOKPROC = CFUNCTYPE(UINT, HWND, UINT, WPARAM, LPARAM)
OFN_FILEMUSTEXIST = 4096
OFN_PATHMUSTEXIST = 2048
...
class WNDCLASSEX(Structure):
    ...
    def __init__(self,
        ...
        from usbcreator.misc import text_type
        ...
        self.lpszMenuName = text_type(menuName)
        self.lpszClassName = text_type(className)
