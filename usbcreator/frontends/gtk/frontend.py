...
class GtkFrontend(Frontend):
    ...
    def startup_failure(cls, message):
        dialog = Gtk.MessageDialog(parent=None, flags=0, message_type=Gtk.MessageType.ERROR,
    ...
    def retry(self, message):
        retry_dialog = Gtk.MessageDialog(parent=self.window, flags=Gtk.DialogFlags.MODAL |
